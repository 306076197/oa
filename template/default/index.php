...
<div class="header">
	<div class="logo lf"><a href="" target="_blank"><span class="invisible">hudson网络办公系统</span></a></div>
    <div class="rt-col">
    	<div class="tab_style white cut_line text-r"><a href="javascript:;" onClick="show_userback()"><img src="template/default/images/u_zx1.gif"> 聊天</a><span>|</span><a href="desk.php">桌面快捷方式</a><span>|</span><a href="javascript:;" onClick="show_config()">授权</a><span>|</span><a href="http://bbs.phpoa.cn/" target="_blank">帮助？</a>
 <ul id="Skin">
